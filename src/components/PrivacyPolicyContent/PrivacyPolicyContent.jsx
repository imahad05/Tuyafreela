...
const PrivacyPolicyContent = () => {
  ...
  return (
    <div className="privacy-policy-content">
      <h1 className="privacy-policy-heading">Política de privacidade</h1>
          ...
          return (
            <div key={index}>
              <h1 className="privacy-policy-title">
                <div className="privacy-policy-shape"></div> {item.title}
              </h1>
              <p className="privacy-policy-desc">{item.desc}</p>
            </div>
          );
        })}
      </div>
